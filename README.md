...
<p align="center">
  <a href="https://gabrielavidales.github.io/Solids-1.0-Users-Guide/#">
    <img src="https://img.shields.io/badge/🌐 Try it live-Visit the Guide-1D9E75?style=for-the-badge" alt="Try it live"/>
  </a>
</p>
...
This repository contains the **interactive web-based user guide** for **Solids 1.0**, a scientific software package for **crystal structure prediction (CSP)** via global optimization on the potential energy surface (PES).

> **Note on authorship:** The Solids 1.0 software was developed by **Carlos López-Castro** ([@Carloast0790](https://github.com/Carloast0790)) at CINVESTAV Mérida. This repository contains only the **interactive documentation website** — designed, built, and maintained by **Gabriela Vidales Ayala** ([@GabrielaVidales](https://github.com/GabrielaVidales)) under the supervision of Dr. Filiberto Ortiz-Chi and Dr. Gabriel Merino.
...
- [Solids 1.0 source code](https://github.com/Carloast0790/SolidASE_0.0) — the Solids package by [@Carloast0790](https://github.com/Carloast0790)
...
| Role | Person |
|------|--------|
| Solids 1.0 software developer | Carlos López-Castro · [@Carloast0790](https://github.com/Carloast0790) · CINVESTAV Mérida |
| User guide (this repo) | Gabriela Vidales Ayala · [@GabrielaVidales](https://github.com/GabrielaVidales) · CINVESTAV Mérida |
